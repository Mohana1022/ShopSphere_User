...
const API_BASE_URL =
  import.meta.env.VITE_API_BASE_URL || "https://final-shopsphere-8v1c.onrender.com";
...
export const submitReturnRequest = async (orderId, returnData) => {
  ...
  const response = await axios.post(`${API_BASE_URL}/request-return/${orderId}`, returnData, {
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json",
    },
